...
# Los test se ejecutan con el comando python "manage.py test messenger"
# o "manage.py test messenger.tests.ThreadTestCase"
# o "manage.py test messenger.tests.ThreadTestCase.test_add_users_to_thread"
